...
MONKEYQUEST_DEFAULT_GROWUP					= true;
...
MONKEYQUEST_DEFAULT_WORKCOMPLETE			= false;
MONKEYQUEST_DEFAULT_COLOURTITLE				= false;
MONKEYQUEST_DEFAULT_FONTHEIGHT				= 11;
